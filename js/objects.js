...
const person = {
    ...
    address: {
        streetNumber: 100,
        streetName: 'Georgian Dr',
        cityName: 'Barrie',
        province: 'Ontario'
    },
    interests: ["reading", "biking", "walking"],
    greetings: function(){
        alert(`Hello ${this.name}, how are you?`); /* call the function as an alert */
    }, 
    bio: function () {
        return `The interests of ${this.name.lastName}, of age ${this.age}, living in ${this.address.cityName} are ${this.interests}`; 
    }
}
...
output.textContent = person.bio(); /* display */
